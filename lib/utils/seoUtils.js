...
export const generateMCQStructuredData = (category, mcqs) => {
  return {
    ...
    "url": `https://www.mcqsbase.com/mcqs/${category.toLowerCase().replace(/\s+/g, '-')}`,
...
export const generateQuizStructuredData = (category, questions) => {
  return {
    ...
    "url": `https://www.mcqsbase.com/quiz/${category.toLowerCase().replace(/\s+/g, '-')}`,
...
export const generatePastPaperStructuredData = (organization, papers) => {
  return {
    ...
    "url": `https://www.mcqsbase.com/past-papers/${organization.toLowerCase()}`,
    "mainEntity": {
      "@type": "ItemList",
...
export const generateInterviewStructuredData = (organization, questions) => {
  return {
    ...
    "url": `https://www.mcqsbase.com/past-interviews/${organization.toLowerCase()}`,
...
export const generateOrganizationStructuredData = () => {
  return {
    ...
    "logo": "https://www.mcqsbase.com/eagle.svg",
...
export const generateWebSiteStructuredData = () => {
  return {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://www.mcqsbase.com/search?q={search_term_string}",
...
export const generatePageMetadata = (pageName, category = null, additionalKeywords = []) => {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://www.mcqsbase.com/${pageName.toLowerCase().replace(/\s+/g, '-')}`,
