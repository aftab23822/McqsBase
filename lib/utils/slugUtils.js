...
export function normalizeDepartmentName(departmentName) {
  ...
  const base = generateSlug(departmentName);

  // Special-case normalization so "Junior Clerk" style departments
  // consistently map to "junior-clerk"
  if (base.includes('junior-clerk')) {
    return 'junior-clerk';
  }
