  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/quiz/chemical-engineering?page=${currentPage}&limit=${quizPerPage}`);
    ...
    <div className="relative">
      <div className={isPageChanging ? 'opacity-60 pointer-events-none transition-opacity duration-300' : 'transition-opacity duration-300'}>
        <BaseQuiz
          ...
          title="Chemical Engineering Quiz"
...
export default ChemicalEngineeringQuiz; 