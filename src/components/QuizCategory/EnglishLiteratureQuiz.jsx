  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/quiz/english-literature?page=${currentPage}&limit=${quizPerPage}`);
...
export default EnglishLiteratureQuiz; 