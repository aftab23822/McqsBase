...
const InternationalRelationsQuiz = () => {
  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/quiz/international-relations?page=${currentPage}&limit=${quizPerPage}`);
...
export default InternationalRelationsQuiz; 