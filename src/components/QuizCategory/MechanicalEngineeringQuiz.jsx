...
const MechanicalEngineeringQuiz = () => {
  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/quiz/mechanical-engineering?page=${currentPage}&limit=${quizPerPage}`);
...
export default MechanicalEngineeringQuiz; 