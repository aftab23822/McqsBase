  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/mcqs/general-anatomy?page=${currentPage}&limit=${mcqsPerPage}`);
...
export default GeneralAnatomyMcqs; 