...
const InternationalRelationsMcqs = () => {
  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/mcqs/international-relations?page=${currentPage}&limit=${mcqsPerPage}`);
...
export default InternationalRelationsMcqs; 