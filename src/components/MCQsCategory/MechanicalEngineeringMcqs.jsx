...
const MechanicalEngineeringMcqs = () => {
  ...
  const [totalPages, setTotalPages] = useState(1);
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await apiFetch(`/api/mcqs/mechanical-engineering?page=${currentPage}&limit=${mcqsPerPage}`);
...
export default MechanicalEngineeringMcqs; 