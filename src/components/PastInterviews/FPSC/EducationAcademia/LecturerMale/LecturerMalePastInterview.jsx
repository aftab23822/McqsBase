...
const LecturerMalePastInterview = () => {
  ...
  useEffect(() => {
    setLoading(true);
    apiFetch(`/api/interviews/lecturer-male?page=${currentPage}&limit=${interviewsPerPage}`)
      .then((res) => {
  ...
  return (
    <BasePastInterview
      ...
      title="Lecturer (Male) Past Interview"
...
export default LecturerMalePastInterview; 