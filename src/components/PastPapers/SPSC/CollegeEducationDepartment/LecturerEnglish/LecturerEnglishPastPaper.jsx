...
const LecturerEnglishPastPaper = () => {
  ...
  useEffect(() => {
    setLoading(true);
    apiFetch(`/api/pastpapers/lecturer-english?page=${currentPage}&limit=${mcqsPerPage}`)
      .then((res) => {
  ...
  return (
    <BasePastPaper
      ...
      title="Lecturer English Past Paper"
...
export default LecturerEnglishPastPaper; 